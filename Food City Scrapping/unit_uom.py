    ...
    def get_unit_uom(Description):
        ...
        if re.search(
            ...
            if (re.search(
                    ...
                    Description, re.IGNORECASE)):
                uom = re.search(
                    "(lb| lb|Lb| Lb| LB| LB|Cup| Cup| Cup |sq yd| sq yd| sq yd |bottles| bottles |bottles | bottles|rolls| rolls|Count| Count|L | L|-L|sq ft| sq ft|fl oz |floz | floz|floz| FOz| FOz|-FOz|Cubic Inches| Cubic Inches|-Cubic Inches|cubic in| cubic in|-cubic in|Gram| Gram |-Gram|Sq. Ft.|Ffl oz|FS| FS|-FS|fs| fs|-fs|Cubic Feet| Cubic Feet|-Cubic Feet|cubic feet| cubic feet|-cubic feet|Fluid Ounce| Fluid Ounce|-Fluid Ounce|fluid ounce| fluid ounce|-fluid ounce|Ct| Ct|-Ct|ct| ct|-ct|Dozen| Dozen|-Dozen|dozen| dozen|-dozen|inches|-inches|inches| ft.|-ft.|ft.| ft|-ft|ft|-mg| mg|mg|-Inch| mm|mm| fl.oz.| fl oz|FL OZ|Fl. Oz.|OZ|Count| Count|-Gal.|GAL|-LBS| LBS|LBS|-LB| LB|LB|ML|-QTS| QTS|QTS|GAL|-GALLON| GALLON|GALLON|GRAMS|GRM|-GM.| GM|-GM |GM |-GR |GR | GR |-liter| liter|liter|-LTR| LTR|LTR|LT|CU.IN|QT|-QT| QT|CU. IN|INCH|IN|Cu.Ft|cu ft|OUNCE|-ounce| ounce|-PINT| PINT|PINT|pound| pound|-pound|PT|QUART|SG|YD| Inch| Yard|-Yard|Yard|L | L |-L |Each | each|EACH |each |Gummies| Gummies |gummies | gummies|Cubic Ft|Count| Count| ea| FZ)",
                    input, re.IGNORECASE)
                if uom:
                    uom = uom.group()
                else:
        ...
        if uom == "":
            if (re.search(
                ...
                if (re.search(
                        ...
                        Description, re.IGNORECASE)):
                    uom = re.search(
                        "(fl oz | cu.ft.| sq.ft.|cu.ft.|sq.ft.| EA |EA |markers| markers|-markers|marker| marker|-marker|Meter(s)|-Meter(s)|Meter| Meter|-Meter|-Volt| Volt|mcg|-mcg| mcg|kg|-kg| kg|-G |G | g |g |-g |Each | each|EACH |each |Gummies| Gummies |gummies | gummies)",
                        input, re.IGNORECASE)
                    if uom:
                        uom = uom.group()
                    else:
        ...
        if re.search(
                "((\d+|\.\d+)+(|\s+)(pack-of|pack of - |pack of-|pack of |pack of|pack| pack|-pack|packs| packs|-packs|pk |-pk |-pk. |-pk. |Pk|Pc.| Pc.|pack of|pack|pk| pk|-pack)(|\s+))|((\d+|\.\d+)+(|\s+)-(|\s+)(\d+|\.\d+)+(|\s+)(Pack-of|Pack of - |pack of-|pack of |pack of|pack| pack|-pack|packs| packs|-packs|pk |-pk |-pk. |-pk.|Pc.| Pc. )(|\s+))|((\d+|\.\d+)+(|\s+)/(|\s+)(\d+|\.\d+)+(|\s+)(Pack-of|Pack of - |Pack of-|Pack of |Pack of|Pack| Pack|-Pack|Packs| Packs|-Packs|pk |-pk |-pk. |-pk.|Pc.| Pc. )(|\s+)|(pack of|pack of |Pack of - |pack of-|pack-of-)(\d+|\.\d+)+(|\s+))",
                input):
            input2 = re.search(
                "((\d+|\.\d+)+(|\s+)(pack-of|pack of - |pack of-|pack of |pack of|pack| pack|-pack|packs| packs|-packs|pk |-pk |-pk. |-pk. |pk|pc.| pc.|-pack)(|\s+))|((\d+|\.\d+)+(|\s+)-(|\s+)(\d+|\.\d+)+(|\s+)(pack-of|pack of - |pack of-|pack of |pack of|pack| pack|-pack|packs| packs|-packs|pk |-pk |-pk. |-pk.|Pc.| Pc. )(|\s+))|((\d+|\.\d+)+(|\s+)/(|\s+)(\d+|\.\d+)+(|\s+)(Pack-of|Pack of - |Pack of-|Pack of |Pack of|Pack| Pack|-Pack|Packs| Packs|-Packs|pk |-pk |-pk. |-pk.|Pc.| Pc. )(|\s+)|(pack of|pack of |Pack of - |pack of-|pack-of-)(\d+|\.\d+)+(|\s+))",
                input)
            if input2:
                input2 = input2.group()
            else:
...
# print(uom_uom_pack.get_unit_uom('Loreal Paris Infallible Pro Matte Foundation Soft Sable 1 Fz - 1FLOz'))